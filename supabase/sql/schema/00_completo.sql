...
-- Gerado juntando 01_profiles.sql ... 10_storage_buckets.sql, nessa ordem.
-- Precisa da tabela tenants (00_tenants.sql, na pasta supabase/sql/) ja criada antes.
-- Cole tudo de uma vez no SQL Editor do projeto novo e rode.
--
